...
var EntityStore = (function () {
    ...
    EntityStore.prototype.get = function (dataId, fieldName) {
        ...
        if (hasOwn$1.call(this.data, dataId)) {
            ...
            if (!fieldName)
                return storeObject;
            if (hasOwn$1.call(storeObject, fieldName)) {
...
var ApolloProvider = function (_a) {
    ...
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? invariant.invariant(context.client, 6) : invariant.invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
...
var ApolloConsumer = function (props) {
    ...
    var ApolloContext = getApolloContext();
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        process.env.NODE_ENV === "production" ? invariant.invariant(context && context.client, 5) : invariant.invariant(context && context.client, 'Could not find "client" in the context of ApolloConsumer. ' +
...
function parser(document) {
    ...
    process.env.NODE_ENV === "production" ? invariant.invariant(!!document && !!document.kind, 7) : invariant.invariant(!!document && !!document.kind, "Argument of " + document + " passed to parser was not a valid GraphQL " +
    ...
    process.env.NODE_ENV === "production" ? invariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), 8) : invariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), "Passing only a fragment to 'graphql' is not yet supported. " +
        "You must include a query, subscription or mutation as well");
    process.env.NODE_ENV === "production" ? invariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, 9) : invariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, "react-apollo only supports a query, subscription, or a mutation per HOC. " +
    ...
    var definitions = queries.length
        ...
        : mutations.length
            ? mutations
            : subscriptions;
    process.env.NODE_ENV === "production" ? invariant.invariant(definitions.length === 1, 10) : invariant.invariant(definitions.length === 1, "react-apollo only supports one definition per HOC. " + document + " had " +
...
function useApolloClient() {
    ...
    process.env.NODE_ENV === "production" ? invariant.invariant(client, 11) : invariant.invariant(client, 'No Apollo Client instance can be found. Please ensure that you ' +
